...
function san() {
  ASAN_OPTIONS=detect_leaks=1:detect_stack_use_after_return=1:check_initialization_order=1: ./$1
}
alias c="clear"
alias n="norminette"
alias nf="python3 -m c_formatter_42 *.c *.h"
alias f="francinette"
alias fs="francinette --strict"
...
alias fdf="cd /media/wdevries/Samsung\ USB/dev/fdf"
alias ppx="cd /media/wdevries/Samsung\ USB/dev/ppx"
alias psw="cd /media/wdevries/Samsung\ USB/dev/psw"
alias phi="cd /media/wdevries/Samsung\ USB/dev/philo"
alias msh="cd /media/wdevries/Samsung\ USB/dev/msh"
...
alias francinette=/nfs/homes/wdevries/francinette/tester.sh

alias paco=/nfs/homes/wdevries/francinette/tester.sh
